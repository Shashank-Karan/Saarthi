      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-8 gap-4">
          <div className="flex-1">
            <h2 className="text-2xl sm:text-3xl font-serif font-bold text-foreground mb-2">Personal Journal</h2>
            <p className="text-sm sm:text-base text-muted-foreground">Reflect on your spiritual journey and capture your thoughts</p>
          </div>
          {user && (
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              <DialogTrigger asChild>
                <Button className="shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto" data-testid="button-create-entry">
            ...
            {isLoading ? (
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  >
                    <Plus className="mr-2 h-4 w-4" />
                    <span className="hidden xs:inline">Write Your First Entry</span>
                    <span className="xs:hidden">First Entry</span>
                  </Button>
                </CardContent>
              </Card>
            ) : (
              <div className="grid gap-3 sm:gap-4 md:gap-6 grid-cols-1 lg:grid-cols-2 auto-rows-max" data-testid="journal-entries">
                  ...
                  >
                    <CardContent className="p-3 sm:p-4">
                      <div className="flex justify-between items-start mb-3 gap-2">
                        <CardTitle className="text-base sm:text-lg font-serif flex-1 break-words min-w-0">
                          {entry.title}
                        </CardTitle>
